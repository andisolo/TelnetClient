package com.example.lenovo.telnetclient.fillblankview;
...
public class FillBlankView extends RelativeLayout {
    ...
    public void setData(String originContent, List<AnswerRange> answerRangeList) {
        ...
        if (TextUtils.isEmpty(originContent) || answerRangeList == null) {
            return;
        } else if (answerRangeList.isEmpty()) {
            answerRangeList.add(new AnswerRange(0, 0));
        }
        ...
        for (int i = 0; i < rangeList.size(); i++) {
            ...
            content.setSpan(blankClickableSpan, range.start, range.end, Spanned
    ...
    class BlankClickableSpan extends ClickableSpan {
        ...
        public void onClick(final View widget) {
            ...
            final EditText etInput = view.findViewById(R.id.et_answer);

            Button btnFillBlank = view.findViewById(R.id.btn_fill_blank);
            ...
            final PopupWindow popupWindow = new PopupWindow(view, LayoutParams.MATCH_PARENT,
                    dp2px(40));
